...
const UploadImageAttachment: FC<Props> = ({ attachments, setAttachments }) => {
  ...
  return (
    ...
    >
      {loading ? <Spinner size="sm" /> : <PhotographIcon className="w-6 h-6 text-brand" />}
...
export default UploadImageAttachment;
